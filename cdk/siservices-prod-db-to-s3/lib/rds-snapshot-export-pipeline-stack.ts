        ...
        "Statement": [
          {
              ...
              "Effect": "Allow",
              "Principal": {
                  "AWS": "arn:aws:iam::301027959319:root"
              },
              "Action": "kms:*",
              "Resource": "*"
          },
          {
            ...
            "Principal": {
                "AWS": [
                    "arn:aws:iam::301027959319:user/jamila",
                    "arn:aws:iam::301027959319:user/eric",
                    "arn:aws:iam::301027959319:user/thomas.low@circle.com"
                ]
            },
            "Action": [
                "kms:Create*",
